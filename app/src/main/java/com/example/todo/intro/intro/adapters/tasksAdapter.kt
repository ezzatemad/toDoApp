...
//            holder.item_title.setTextColor(holder.view.resources.getColor(R.color.task_done))


        } else {
            holder.item_check.visibility= View.VISIBLE
            holder.item_complete.visibility = View.GONE
//            holder.item_title.setTextColor(holder.view.resources.getColor(R.color.blue))
        }
    ...
    fun getItemAtPosition(position: Int): taskData? {
